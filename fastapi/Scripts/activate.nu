...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ayoub\Documents\GitHub\Hitema-python-API\fastapi'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ayoub\Documents\GitHub\Hitema-python-API\fastapi\Scripts\deactivate.nu'
